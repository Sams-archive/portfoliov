...
export default function Home() {
  return (
    <section id="home" className="relative z-10">
      <div className="flex flex-col px-4 sm:px-6 md:mx-20  my-16 md:mt-22">
        <div className="inline-flex items-center gap-2  px-3 py-4 bg-green-50/50 border border-green-100 w-60 mt-4 mb-4 rounded-full">
